...
- **Local UAT (`make uat-axe`):** scenario definitions, `axe` batch list, MP4 defaults, and launch-argument contract live in **`Scripts/axe/README.md`**. Driver: [`Scripts/uat_axe_run.sh`](Scripts/uat_axe_run.sh).
