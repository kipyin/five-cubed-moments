...
- Past: **Search journal** stays on the Past tab — the field and results are inline instead of opening a separate search screen; clearing the query restores the usual Past cards.
