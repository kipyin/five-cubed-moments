...
final class MarketingVersionTests: XCTestCase {
    ...
    func test_orientationReleaseGate_priorLaunchBeforeAnchor() {
        ...
        XCTAssertFalse(OrientationReleaseGate.isPriorLaunchBeforeRelease(marketing: "0.5.0", storedBundle: 8))
    ...
    func test_orientationReleaseGate_currentAtOrAfterAnchor() {
        ...
        XCTAssertTrue(OrientationReleaseGate.isCurrentLaunchAtOrAfterRelease(marketing: "0.5.0", bundle: 8))
