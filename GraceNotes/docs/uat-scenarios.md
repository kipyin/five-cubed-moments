...
| UAT-02 | Demo **Past** tab | Same as UAT-01 | [`JournalMostRecurringUITests.swift`](../../GraceNotesUITests/JournalMostRecurringUITests.swift) (Past insights) | [`02_navigate_past.txt`](../../Scripts/axe/batch/02_navigate_past.txt) | PNG | Insights / history load; no blank root; scroll feels sane |
...
| UAT-08 | **Most recurring** / Past cards | Demo seed or UITest data | `JournalMostRecurringUITests` | TBD | PNG | Card copy; browse affordances if seeded |
