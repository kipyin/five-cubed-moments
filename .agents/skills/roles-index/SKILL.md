...
- **Skill folders** use verb slugs (`strategize`, `build`, `promote`, `test`, …) while **handoff role titles** in docs may stay noun-style (**Strategist**, **Builder**, **Marketing**, **Test Lead**, …).
