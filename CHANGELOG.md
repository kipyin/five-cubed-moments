...
- **Local UAT (`make uat-axe`):** scenario definitions, `axe` batch list, MP4 defaults, and launch-argument contract live in **`Scripts/axe/README.md`**; [`GraceNotes/docs/uat-scenarios.md`](GraceNotes/docs/uat-scenarios.md) is a stub that links there. Driver: [`Scripts/uat_axe_run.sh`](Scripts/uat_axe_run.sh).
